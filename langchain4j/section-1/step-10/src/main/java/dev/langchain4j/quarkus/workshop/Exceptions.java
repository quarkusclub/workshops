...
public class Exceptions {
    ...
    public static class BookingCannotBeCreatedException extends RuntimeException {
        public BookingCannotBeCreatedException(String reason) {
            super("Booking cannot be created because %s".formatted(reason));
        }
    }
}
